...
function showTemp(response) {
  ...
  let mainTemperature = document.querySelector(".mainTemperature"); // Say that mainTemperature will be shown in the class MainTemperature
  ...
  let weatherDescription = document.querySelector("#temperature-description"); // Says that weatherDescription will be shown in the ID temperature-description
